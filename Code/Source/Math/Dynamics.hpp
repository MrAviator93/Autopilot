...
#ifndef ATL_CORE_MATH_DYNAMICS_HPP__
#define ATL_CORE_MATH_DYNAMICS_HPP__
...
public:
	...
	static inline scalar calcReynoldsNumber( const scalar density,
	...
	//			MAC [m],
	//			Wing Area [m^2]
	static inline scalar calcHorizontalTailVolumeRatio( const scalar horizontalTailArea,
														const scalar lt,
														const scalar MAC,
	...
	//			Wing Span [m],
	//			Wing Area [m^2]
	static inline scalar calcVerticalTailVolumeRatio( const scalar verticalTailArea,
													  const scalar lv,
	...
	static inline scalar estimateDragDueToAoA( const scalar coeficientOfLift,
	...
	static inline scalar estimateChangeInDownwashDueToAoA( const scalar liftDuetoAngleOfAttack,
														   const scalar wingAspectRatio );
};

} // namespace ATL::Core::Math
#endif // !ATL_CORE_MATH_DYNAMICS_HPP__